 ...
 * <li>Authentication errors (BadCredentialsException,
 * UsernameNotFoundException)</li>
...
public class GlobalExceptionHandler {
         ...
         * 
         * <p>
         * These exceptions already contain the appropriate HTTP status code
         * and error message.
         * </p>
         * 
         ...
         * 
         * <p>
         * Collects all field validation errors and returns them as a list
         ...
         * 
         * <p>
         * Triggered when Spring Security authentication fails during login.
         * </p>
         * 
         ...
         * 
         * <p>
         * In production, consider logging these exceptions for debugging.
         * </p>
         * 
