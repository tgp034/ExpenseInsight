...
public class DashboardService {
        ...
        public DashboardSummary getDashboardSummary(Long userId, LocalDate startDate, LocalDate endDate) {
                ...
                log.debug("Building dashboard summary for user {} between {} and {}", userId, startDate, endDate);
        ...
        public StatisticsResponse getStatistics(Long userId, LocalDate startDate, LocalDate endDate) {
                ...
                return StatisticsResponse.builder()
                                ...
                                .largestExpense(
                                                largestExpenseTransaction != null
                                                                ? largestExpenseTransaction.getAmount()
                                                                : BigDecimal.ZERO)
                                .largestExpenseDescription(
                                                largestExpenseTransaction != null
                                                                ? largestExpenseTransaction.getDescription()
                                                                : "N/A")
        ...
        private void validateDateRange(LocalDate startDate, LocalDate endDate) {
                ...
                if (startDate.isAfter(endDate)) {
                        log.warn("Invalid date range received: startDate={} endDate={}", startDate, endDate);
